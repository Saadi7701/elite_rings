  ...
  return (
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <Link to="/" className="nav-brand" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <img src="/latelier_logo.png" alt="JI Logo" style={{ height: '32px', display: 'block' }} />
        <span style={{ fontFamily: 'var(--font-serif)', fontSize: '1.5rem', fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase' }}>JI JEWELS</span>
      </Link>
